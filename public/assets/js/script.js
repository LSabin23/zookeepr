...
const handleAnimalFormSubmit = event => {
  ...
  fetch('/api/animals', {
    ...
    .then(postResponse => {
      ...
      // this still shows even if the animal doesn't meet requirements to be added
...
const handleZookeeperFormSubmit = event => {
  ...
  fetch('api/zookeepers', {
    ...
    .then(postResponse => {
      console.log(postResponse)
      // this still shows even if the zookeeper doesn't meet the requirements to be added
